%dw 2.0
import java!org::mule::module::RSAHelper
import jwt::Common
...
fun generateJWT(header: Object, payload: Object, pkcs8privateKey: String, algorithm: String) : String = do {
    var jwt = Common::JWT(
...
/** JWT with payload and automatically generated header, signed with algorithm */
fun generateJWT(payload: Object, pkcs8privateKey: String, algorithm: String) : String =
    generateJWT({}, payload, pkcs8privateKey, algorithm)